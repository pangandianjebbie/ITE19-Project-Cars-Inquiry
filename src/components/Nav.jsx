...
function Nav() {
  ...
  return (
    ...
    >
        ...
        > 
          ...
          <li className="mb-3">
            <button onClick={handleInbox}>
              <span>
                <FiInbox className={`text-black w-7 h-7 ml-4 lg:ml-5 hover:text-pink-800 ${
                  visible ? "text-orange-500" : "text-yellow-200"
                }`} />
              </span>
            </button>
          </li>   
      ...
      <Modal isvisible={showModal1} onClose={handleCloseModal}>
        <Inbox onClose={handleCloseModal} />
      </Modal>
    </div>
